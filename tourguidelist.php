...
<body>
 ...
 <!-- ======================================================= Blog Photos End ====================================================== -->
      <div class="fuck">
         <br><br><br>
        <font face="Cooper Black"> <h1> Tour Guide</h1> </font>
        <font face="Arial Rounded MT Bold"> <h2>List of tour guide</h2></font>
      <br><br>
      </div>
    ...
    <div class="row">
      <div class="col-sm-1"></div>
       ...
       <div class="column">
        <div class="card">
          ...
          <div class="container">
            <h3>Abu Saleh Nahid</h3>
            <p class="title">Dhanmondi,Dhaka</p>
            <p>Some text that describes me lorem ipsum ipsum lorem.</p>
            <p>example@example.com</p>
            <a href="tourguide.php" target="blank"><button class="button" style="width: 328px;">Contact</button></a>
          </div>
        </div>
      </div>
      ...
      <div class="column">
        <div class="card">
          ...
          <div class="container">
            <h2>Abdul Malek</h2>
            <p class="title">Baridhara,Dhaka</p>
            <p>Some text that describes me lorem ipsum ipsum lorem.</p>
            <p>example@example.com</p>
            <a href="tourguide.php" target="blank"><button class="button" style="width: 328px;">Contact</button></a>
          </div>
      ...
      <div class="column">
        <div class="card">
          <img src="img/84.jpg" alt="John" style="width:100%">
          <div class="container">
            <h2>Jakir khan</h2>
            <p class="title">Demra,Dhaka</p>
            <p>Some text that describes me lorem ipsum ipsum lorem.</p>
            <p>example@example.com</p>
            <a href="tourguide.php" target="blank"><button class="button" style="width: 328px;">Contact</button></a>
          </div>
    ...
    <div class="row">
      ...
      <div class="column">
        <div class="card">
          <img src="img/87.jpg" alt="Jane" style="width:100%">
          <div class="container">
            <h2>Jenifer Amina</h2>
      ...
      <div class="column">
        <div class="card">
          <img src="img/99.jpg" alt="Mike" style="width:100%">
          <div class="container">
            <h2>MD. Khalek</h2>
            <p class="title">Gulisthan,Dhaka</p>
            <p>Some text that describes me lorem ipsum ipsum lorem.</p>
            <p>example@example.com</p>
            <a href="tourguide.php" target="blank"><button class="button" style="width: 328px;">Contact</button></a>
          </div>
      ...
      <div class="column">
        <div class="card">
          ...
          <div class="container">
            <h2>John Doe</h2>
            <p class="title">Kolabagan,Dhaka</p>
            <p>Some text that describes me lorem ipsum ipsum lorem.</p>
            <p>example@example.com</p>
            <a href="tourguide.php" target="blank"><button class="button" style="width: 328px;">Contact</button></a>
          </div>
